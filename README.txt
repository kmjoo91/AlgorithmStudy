...
8이 포함되어 있는 숫자의 갯수를 카운팅 하는 것이 아니라 8이라는 숫자를 모두 카운팅 해야 한다.
(※ 예를들어 8808은 3, 8888은 4로 카운팅 해야 함)
(출처 - http://codingdojang.com/scode/393)
...
이 방법으로 해결할 경우 O(log n)으로 해결이 가능합니다. (log의 밑은 10입니다.)
...
예를들어 10000을 기준으로 생각하면 만의 자리에서 몇번 등장하는지 카운팅할 경우 00000~099999까지 계산하게 되는데.이것은 0이라는 숫자가 10000번 더 등장한 것으로 보게됩니다.
